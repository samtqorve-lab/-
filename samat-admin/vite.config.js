...
// (نه یک asset خام) و آن را با یک نام هش‌دار جدا کپی می‌کند، ولی importDِ نسبیِ داخلی خودش
...
// راه‌حل: هر دو فایلِ به‌هموابسته (worker + shared) را عیناً و بدون هیچ پردازش، کنار هم و با
