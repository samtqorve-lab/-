 ...
 * هم از همان مشکل رنج می‌برد و می‌توانست دوباره برای همیشه گیر کند — دقیقاً همان چیزی که باعث شد
 * حتی با آن fix هم صفحه‌ی ورود همچنان (این‌بار چند ثانیه دیرتر) بی‌هیچ پیام خطایی گیر کند. حالا
 * timeout مستقیم روی خودِ fetch است، پس هر فراخوانی این تابع (هرجا که باشد) محافظت دارد.
 */
